                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ms-4">
                                <div class="text-sm font-medium text-gray-500">Transaksi Pending</div>
                                <div class="text-2xl font-bold text-gray-900">{{ $pendingTransactions }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ms-4">
                                <div class="text-sm font-medium text-gray-500">Transaksi Valid</div>
                                <div class="text-2xl font-bold text-gray-900">{{ $validTransactions }}</div>
                            </div>
                        </div>
                    </div>
                </div>
