                ...
                <div class="p-6">
                    <form action="{{ route('owner.products.update', $product) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" rows="4" class="mt-1 block w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm">{{ old('description', $product->description) }}</textarea>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('owner.products.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400 transition ease-in-out duration-150">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
